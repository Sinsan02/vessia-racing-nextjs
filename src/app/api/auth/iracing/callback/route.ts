...
export async function GET(request: NextRequest) {
  try {
    ...
    const tokenResponse = await fetch('https://members-ng.iracing.com/oauth2/token', {
      method: 'POST',
      headers: {
    ...
    const userInfoResponse = await fetch('https://members-ng.iracing.com/oauth2/userinfo', {
      headers: {
